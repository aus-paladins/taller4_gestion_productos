...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtFilter jwtFilter) throws Exception {
        http
                .csrf(csrf -> csrf.disable()) //Cambié esta línea porque sino no levantaba el back, por un conflicto de versiones
                .cors(cors -> {})             //Esta línea es para que el front pueda hacer peticiones al back
